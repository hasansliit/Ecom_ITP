...
import { FaPaperclip } from "react-icons/fa"; // Icon for attachment
import { MdShare } from "react-icons/md"; // Importing the share icon

const TicketModal = ({ tickets, onClose }) => {
  // Function to create a mailto link with ticket details
